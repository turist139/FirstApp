...
with open("MyFocus/Models/SchemaVersions.swift", "w") as f:
    ...
    f.write("    static var models: [any PersistentModel.Type] {\n")
    f.write("        // Reference the current global models in the app\n")
    f.write("        [MyFocus.FocusSession.self, MyFocus.UserProgress.self, MyFocus.BreakActivity.self, MyFocus.MindfulnessSession.self, MyFocus.DetoxLog.self, MyFocus.PastStreak.self, MyFocus.DetoxProfile.self]\n")
    f.write("    }\n")
    f.write("}\n\n")
